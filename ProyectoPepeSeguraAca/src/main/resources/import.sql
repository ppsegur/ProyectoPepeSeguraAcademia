...
INSERT INTO Usuario(id,username,contrasena,nombre,apellidos,correo,dni) 
VALUES (1,'pepe321', 'pepe123', 'Pepe', 'González Pérez', 'pepe@example.com', '12345678A');

INSERT INTO   Usuario (id,username,contrasena,nombre,apellidos,correo,dni)
VALUES (2, 'marialoma', 'contraseña2', 'María', 'López Martínez', 'maria@example.com', '87654321B');

ALTER SEQUENCE Usuario_seq RESTART WITH 51;

INSERT INTO Estudiante (id, telefono) 
VALUES (1, '123456789');

INSERT INTO Estudiante (id, telefono) 
VALUES (2, '987654321');

ALTER SEQUENCE Estudiante_seq RESTART WITH 51;
