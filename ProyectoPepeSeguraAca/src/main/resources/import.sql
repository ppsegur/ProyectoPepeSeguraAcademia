...
INSERT INTO Usuario(id,username,contrasena,nombre,apellidos,correo,dni) VALUES (1,'pepe321', 'pepe123', 'Pepe', 'González Pérez', 'pepe@example.com', '12345678A');

INSERT INTO   Usuario (id,username,contrasena,nombre,apellidos,correo,dni) VALUES (2, 'marialoma', 'contraseña2', 'María', 'López Martínez', 'maria@example.com', '87654321B');
