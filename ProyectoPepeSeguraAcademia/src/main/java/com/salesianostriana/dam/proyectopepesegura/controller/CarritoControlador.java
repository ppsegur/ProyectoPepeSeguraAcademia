...
// Redirigir a una página de confirmación o de lista de cursos
	 ...
	 * 
	 * @PostMapping("/eliminar") public String eliminarCurso(@RequestParam Long
	 * cursoId, @AuthenticationPrincipal Estudiante estudiante) {
	 * carritoServicio.eliminarCurso(estudiante, cursoId); return
	 * "redirect:/carrito"; }
	 */
}
